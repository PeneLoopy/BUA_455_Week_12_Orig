...
- Posting HTML files for free using **[Rpubs](https://rpubs.com/)** 
  ...
  - Useful for presenting a dashboard
...
asia_intr_map <- ggplotly(asia_bxo_map_intr, 
                           tooltip = c("text","color")) # interactive component

```

---

### Asia Interactive Map with Log (LN) Transformation 
(projection Needs Work)
...
```{r euro interactive map, fig.dim=c(15,7), echo=F, fig.align='center'}
...
```{r us state interactive map, echo=F, fig.dim=c(12,7), fig.align='center'}
...
```{r base R scatterplot and histogram, fig.dim=c(12,7), fig.align='center', echo=FALSE}
...
### Displaying Population and Percentage with Bachelors Degree side by side
